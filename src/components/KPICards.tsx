...
export const KPICards: React.FC<KPICardsProps> = ({ records = [] }) => {
  ...
  if (hasRecords) {
    ...
    totalMaintenanceCost = records
      .filter((r) => r.category === 'maintenance' || r.category === 'fault' || r.category === 'tax_insurance' || r.category === 'tuning_obd')
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="rounded-xl bg-slate-900/80 border border-slate-800 p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xs text-slate-400 font-mono-code">保養維修 & 車體稅費</div>
          ...
          <div className="text-right">
            <div className="text-xs font-bold text-blue-400 font-mono">{maintenancePct}%</div>
        ...
        <div className="rounded-xl bg-slate-900/80 border border-slate-800 p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xs text-slate-400 font-mono-code">總汽油資 (中油98)</div>
              <div className="text-lg font-tech font-bold text-slate-100">
          ...
          <div className="text-right">
            <div className="text-xs font-bold text-cyan-400 font-mono">{fuelPct}%</div>
            <div className="text-[10px] text-slate-400 font-mono">佔總支出</div>
          </div>
        </div>
        ...
        <div className="rounded-xl bg-slate-900/80 border border-slate-800 p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xs text-slate-400 font-mono-code">鍍膜、洗車與精緻美容</div>
              <div className="text-lg font-tech font-bold text-slate-100">
          ...
          <div className="text-right">
            <div className="text-xs font-bold text-purple-400 font-mono">{detailingPct}%</div>
            <div className="text-[10px] text-slate-400 font-mono">佔總支出</div>
          </div>
        </div>
      </div>
